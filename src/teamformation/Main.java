...
class Defender extends Player {
    ...
    public void setTall(boolean tall) { isTall = tall; }
...
class Midfielders extends Player{
    ...
    public boolean isPasser() { return isPasser; }
    public void setPasser(boolean passer) { isPasser = passer; }
    public boolean isScanner() { return isScanner; }
    public void setScanner(boolean scanner) { isScanner = scanner; }
    public boolean isDribbler() { return isDribbler; }
    public void setDribbler(boolean dribbler) { isDribbler = dribbler; }
    public Position getPosition() { return position; }
    public void setPosition(Position position) { this.position = position; }
...
class Striker extends Player{
    ...
    public boolean isFinisher() { return isFinisher; }
    public void setFinisher(boolean finisher) { isFinisher = finisher; }
